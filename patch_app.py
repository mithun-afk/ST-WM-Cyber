...
pattern = re.compile(r'chart_c1, chart_c2, chart_c3 = st\.columns\(\[1, 2, 2\]\).*?elif result and result\.get\("status"\) == "ERROR":', re.DOTALL)

replacement = '''top_c1, top_c2, top_c3 = st.columns([1, 2, 1])
